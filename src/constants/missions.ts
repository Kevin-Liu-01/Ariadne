...
export const MISSIONS: readonly MissionTemplate[] = [
  ...
  },
  {
    ...
    title: "Word Quest",
    promptCopy:
      "Your secret word is half of a phrase. Find the guest holding the other half. Check the main screen for tonight's word pairs, then text me that guest's game ID and their secret word.",
    points: 150,
    requiresPartner: true,
    projectionEffect: "thread",
    validation: { kind: "word_collab" },
    hint: "your word completes a phrase with one other guest's word. Check the main screen for the word pairs, then text me that guest's game ID and their secret word.",
  ...
  },
  {
    ...
    type: "riddle_quest",
    title: "Riddle Quest",
    promptCopy: 'Three riddles from the labyrinth. Reply with the riddle number and the one-word answer, like "2: cache".',
